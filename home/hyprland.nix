...
hl.bind(mainMod .. " + TAB", hl.dsp.global("caelestia:dashboard"))
-- hl.bind(mainMod .. " + SHIFT", hl.dsp.global("caelestia:sidebar"))
-- hl.bind(mainMod .. " + M", hl.dsp.global("caelestia:controlCenter"))
...
hl.bind("mouse:274",         hl.dsp.workspace.toggle_special("magic"), { release = true })
hl.bind(mainMod .. " + SHIFT + mouse:274", hl.dsp.window.move({ workspace = "special:magic" }), { release = true })
